...
<div class="nav">
    <div class="contents">
        <h1><a href="./LoginMain.cu" tabindex="-1"><img src="https://img.cgv.co.kr/R2014/images/common/logo/logoWhite.png" alt="CGV" /></a></h1>
        <ul class="nav_menu">
            <li>
...
<!-- 실컨텐츠 시작 -->
    <div class="wrap-movie-chart">
        ...
        <form action="MovieCategoryList.cu" method="post">
<font size="4" color="gray"> 장르별 영화 검색</font>&nbsp;&nbsp;
...
<!-- <input type="submit" class="round gray" value="GO">&nbsp;&nbsp; -->
...
<br>
<button onclick="location.href='MovieAllList.cu'" class="round gray"> 영화 전체 검색</button>
...
%>
          <!--이미지를 눌렀을떄 상세보기로 넘어가기. 이때 영화에 대해서  no 만 알면 그 정보를 다 얻어올수 있게 하기 위해서 
                        ...
                        물음표 ?no= bean.getNo  해서 no 를 같이 넘겨준다.  
                ...
                <li>
                    <div class="box-image" >
                        <strong class="rank">No.<%=bean.getNo()%></strong>	
                        <%-- <a href="./MovieReserveInfo.jsp?no=<%=bean.getNo()%>">  --%>
                        <a href="./MovieReserveInfo.cu?no=<%=bean.getNo()%>">
            
                            <span class="thumb-image">
                                <img src="img/<%=bean.getImg() %>" alt="모비우스 포스터" onerror="errorImage(this)"/>
                    ...
                    <div class="box-contents">
                        <a href="/movies/detail-view/?midx=85705">
                            <strong class="title"><%=bean.getName()%></strong>
                        </a>

                        <div class="score">
                            <strong class="percent">예매율<span>41.8%</span></strong>
                        ...
                        <span class="like"> 
                            <a class="link-reservation" href="/ticket/?MOVIE_CD=20029106&MOVIE_CD_GROUP=20029106">예매</a>
                        </span>
                    </div>    
                </li>
            <%
...
%>
                ...
                <li>
                    <div class="box-image" >
                        ...
                        <a href="/movies/detail-view/?midx=85764">
                            <span class="thumb-image">
                                <img src="https://img.cgv.co.kr/Movie/Thumbnail/Poster/000085/85764/85764_320.jpg" alt="[LoL e스포츠]2022 LCK 스프링 플레이오프(2D) 포스터" onerror="errorImage(this)"/>
                    ...
                    <div class="box-contents">
                        <a href="/movies/detail-view/?midx=85764">
                            <strong class="title">[LoL e스포츠]2022 LCK 스프링 플레이오프(2D)</strong>
                        </a>
                        ...
                        <span class="like"> 
                            <a class="link-reservation" href="/ticket/?MOVIE_CD=20029214&MOVIE_CD_GROUP=20029214">예매</a>
                        </span>
                    </div>    
                </li>
                ...
                <li>
                    <div class="box-image" >
                        ...
                        <a href="/movies/detail-view/?midx=85761">
                            <span class="thumb-image">
                                <img src="https://img.cgv.co.kr/Movie/Thumbnail/Poster/000085/85761/85761_320.jpg" alt="THE 장국영 DAY 포스터" onerror="errorImage(this)"/>
                                <span class="ico-grade grade-15">15세 이상</span>
                            </span>
                        </a>
                        <span class="screentype">
                            
                                <a class="sametime" href="#" data-regioncode="ST">SAMETIME</a>
                            
                        </span>
                    </div>
                    <div class="box-contents">
                        <a href="/movies/detail-view/?midx=85761">
                            <strong class="title">THE 장국영 DAY</strong>
                        </a>
                        ...
                        <span class="like"> 
                            <a class="link-reservation" href="/ticket/?MOVIE_CD=20029208&MOVIE_CD_GROUP=20029208">예매</a>
                        </span>
                    </div>    
                </li>
                ...
                <li>
                    <div class="box-image" >
                        ...
                        <a href="/movies/detail-view/?midx=85711">
                            <span class="thumb-image">
                                <img src="https://img.cgv.co.kr/Movie/Thumbnail/Poster/000085/85711/85711_320.jpg" alt="어거스트 버진 포스터" onerror="errorImage(this)"/>
                                <span class="ico-grade grade-15">15세 이상</span>
                            </span>
                        </a>
                        <span class="screentype">
                    ...
                    <div class="box-contents">
                        <a href="/movies/detail-view/?midx=85711">
                            <strong class="title">어거스트 버진</strong>
                        </a>
                        ...
                        <span class="like"> 
                            <a class="link-reservation" href="/ticket/?MOVIE_CD=20029224&MOVIE_CD_GROUP=20029112">예매</a>
                        </span>
                    </div>    
                </li>
                ...
                <li>
                    <div class="box-image" >
                        ...
                        <a href="/movies/detail-view/?midx=79755">
                            <span class="thumb-image">
                                <img src="https://img.cgv.co.kr/Movie/Thumbnail/Poster/000079/79755/79755_320.jpg" alt="아비정전 포스터" onerror="errorImage(this)"/>
                                <span class="ico-grade grade-15">15세 이상</span>
                            </span>
                        </a>
                        <span class="screentype">
                    ...
                    <div class="box-contents">
                        <a href="/movies/detail-view/?midx=79755">
                            <strong class="title">아비정전</strong>
                        </a>
                        ...
                        <span class="like"> 
                            <a class="link-reservation" href="/ticket/?MOVIE_CD=20029202&MOVIE_CD_GROUP=20013138">예매</a>
                        </span>
                    </div>    
                </li>
