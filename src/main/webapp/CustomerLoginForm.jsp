...
<div class="header_content">
    <div class="contents">
        ...
        <ul class="memberInfo_wrap">
            ...
            <li><a href="CustomerLoginForm.cu"><img src="https://img.cgv.co.kr/R2014/images/common/ico/loginPassword.png" alt="로그인" />
            <span>로그인</span></a></li>
...
<div class="wrap-join-2016">
  ...
  <div class="card">
    ...
    <form action="CustomerLoginAction.cu" method="post">
  ...
  <div class="card alt">
    ...
    <form>
      <div class="input-container">
        <input type="text" id="customer_name" required="required"/>
        <label for="">아이디</label>
        <div class="bar"></div>
      </div>
      <div class="input-container">
        <input type="password" id="customer_pw" required="required"/>
        <label for="">비밀번호</label>
        <div class="bar"></div>
      </div>
      <div class="input-container">
     ...
     <div class="input-container">
      ...
      <div class="button-container">
        <button><span>회원가입하기</span></button>
      </div>
    </form>
  </div>
</div>
<!-- Portfolio--><a id="portfolio" href="https://www.vudaily.com" title="View my portfolio!"><i class="fa fa-link"></i></a>
<!-- CodePen--><a id="codepen" href="https://codepen.io/h-sufyan" title="Follow me!"><i class="fa fa-codepen"></i></a>
<!-- partial -->
